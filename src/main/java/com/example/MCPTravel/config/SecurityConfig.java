    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/companies/**").hasAnyRole("BUSINESS_OWNER", "ADMIN")
                .requestMatchers(HttpMethod.PUT, "/api/companies/**").hasAnyRole("BUSINESS_OWNER", "ADMIN")
